...
(function () {
  ...
  const FALLBACK_LANGS = {
    it: "Italiano", en: "English", pa: "ਪੰਜਾਬੀ", hi: "हिन्दी", "hi-Latn": "Hinglish"
  };
  ...
  function getLangFromStorage() {
    ...
    try {
      ...
      if (!obj || typeof obj.v !== "string" || typeof obj.exp !== "number") { localStorage.removeItem(STORAGE_KEY); return null; }
  ...
  function getLangs() {
    try { if (window.LanguageSelector?.LANGS) return window.LanguageSelector.LANGS; } catch {}
  ...
  function init() {
    ...
    if (existing) { hideOverlayNow(overlay); syncAllSelectors(existing); return; }
